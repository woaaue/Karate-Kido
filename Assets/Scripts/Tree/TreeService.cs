...
public sealed class TreeService : MonoBehaviour
{
    ...
    private ETreeType SetTreeType()
    {
        ...
        {
            newType = random > 0.3f ? (random > 0.65f ? ETreeType.Left : ETreeType.Right) : ETreeType.None;
        }
        else
        {
            ...
            {
                newType = random > 0.3f ? (last2 == ETreeType.Left ? ETreeType.Right : ETreeType.Left) : ETreeType.None;
            }
            else
            {
                newType = ETreeType.None;
